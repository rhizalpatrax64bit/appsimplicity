<%@ Control Language="VB" AutoEventWireup="false" CodeFile="DDLEditControl.ascx.vb" Inherits="UI_WebControls_Application_Edit_DDLEditControl" %>
...
<script type="text/javascript" language="javascript">
    ...
    $(function(){ 						
			...
			$('#<%= Me.ddlSelectedValue.ClientId %>').focus( function(){ 
		    ...
		    $('#<%= Me.ddlSelectedValue.ClientId %>').blur( function(){ 
...
<table width="98%" cellpadding="0" border="0">
    ...
    <tr>
        <td>
            <asp:DropDownList ID="ddlSelectedValue" runat="server">
            </asp:DropDownList>
        </td>
    </tr>
