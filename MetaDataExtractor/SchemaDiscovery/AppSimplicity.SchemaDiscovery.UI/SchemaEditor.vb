...
Public Class SchemaEditor
    ...
    Private _Extractor As AppSimplicity.SchemaDiscovery.Engine.MetaDataExtractor

    Private ReadOnly Property Extractor() As AppSimplicity.SchemaDiscovery.Engine.MetaDataExtractor
        Get
            If (_Extractor Is Nothing) Then
                _Extractor = New AppSimplicity.SchemaDiscovery.Engine.MetaDataExtractor
            End If
            Return _Extractor
        End Get
    End Property
    ...
    Private Sub UpdateSchema()
        ...
        Me.Extractor.AttachBackgroundProcess(Me.bgWorker)
    ...
    Private Sub bgWorker_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles bgWorker.DoWork
        Me.Extractor.UpdateProject(_Project)
    End Sub
    ...
    Private Sub bgWorker_RunWorkerCompleted(ByVal sender As System.Object, ByVal e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles bgWorker.RunWorkerCompleted
        ...
        Me.Extractor.DetachBackgroundProcess()
        Me.PersistProject()
        Me.InitializeTree(_Project)
        Me.EnableControls(True)
    End Sub
