...
Public Class MetaDataProviderFactory
    ...
    Private Sub InitializeProviders()
        ...
        Dim lConfiguration As MetaDataProviderSection = Configuration.ConfigurationManager.GetSection("AppSimplicity.SchemaDiscovery")
    ...
    Public Function LoadInstance(providerInvariantName As String) As SchemaDiscovery.IMetaDataProvider
    ...
    Public Shared Function GetInstance(invariantName As String) As SchemaDiscovery.IMetaDataProvider
        ...
        Return lFactory.LoadInstance(invariantName)
    End Function
End Class
