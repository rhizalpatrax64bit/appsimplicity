...
#Region "Shared"
        ...
        ''' </remarks>
        Public Shared Sub RenderTableToExcelFile(ByVal pTable As System.Data.DataTable, ByVal pFileAbsolutePath As String, Optional ByVal pCompressToZip As Boolean = False, Optional ByVal pSelectList As String() = Nothing)
            Dim lExcelUtilities As New ExcelExporter
            lExcelUtilities.RenderDataTableToExcelFile(pTable, pFileAbsolutePath, pCompressToZip, pSelectList)
        End Sub
#End Region
...
#Region "Public"
        ...
        ''' otherwise an exception will be thrown.
        ''' </remarks>
        Public Sub RenderDataTableToExcelFile(ByVal pTable As System.Data.DataTable, ByVal pFileAbsolutePath As String, Optional ByVal pCompressToZip As Boolean = False, Optional ByVal pSelectList As String() = Nothing)
            ...
            Dim lHeader As String = My.Resources.ExcelStrings.ExcelXMLFileHeader
