...
Namespace DataAccess.Providers
    Public MustInherit Class Provider
        ...
        Public Overridable ReadOnly Property CanHandleTransactions() As Boolean
            Get
                Return True
            End Get
        End Property
...
#Region "Command functions"
        Public Function CreateCommand(ByVal pSQLStatement As String, Optional ByVal pType As System.Data.CommandType = CommandType.Text) As DataCommand
            Dim lCommand As New DataCommand(Me)
            lCommand.SQLStatement = pSQLStatement
            lCommand.SQLStatementType = pType
            Return lCommand
        End Function
...
#Region "DB Agnostic Methods"
        Private Function CreateDBParameter(ByVal pParameter As DataParameter) As DbParameter
        ...
        Private Function Execute(ByVal pCommand As DataCommand, ByVal pOperation As DataOperations) As Object
            ...
            Try
                ...
                lCommand.CommandText = pCommand.SQLStatement
                lCommand.CommandType = pCommand.SQLStatementType
                lCommand.CommandTimeout = Me.DataSource.TimeOut

                For Each lParameter As DataParameter In pCommand.Parameters
...
#Region "Public Data Access Methods"
        Public Overridable Function ExecuteScalar(ByVal pCommand As DataCommand) As Object
            Dim lResult As Object = Nothing
        ...
        Public Overridable Function ExecuteDataset(ByVal pCommand As DataCommand) As DataSet
        ...
        Public Overridable Function ExecuteNonQuery(ByVal pCommand As DataCommand) As Integer
        ...
        Public Overridable Function ExecuteDataReader(ByVal pCommand As DataCommand) As DbDataReader
