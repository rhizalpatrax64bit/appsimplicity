...
#Region "Properties"
        ...
        ''' <summary>
        ''' Gets or sets if this column is autogenerated
        ''' </summary>        
        ...
        ''' <summary>
        ''' Gets or sets if this colum can hold a System.DBnull.Value
        ''' </summary>
        ...
        ''' <summary>
        ''' Sets or gets if column is declared as a primary key
        ''' </summary>
